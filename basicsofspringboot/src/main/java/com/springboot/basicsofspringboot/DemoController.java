...
//	 public Customer getByNameAndEmail(@RequestParam String name,@RequestParam String email) {
...
//	    }
	    ...
	    public Car findById(@RequestParam Integer id) {
	    	...
	    	if(car.isPresent()) {
	    		...
	    		throw new CarDataDoestNotExistException();
	    	}
	    }
	    
	    
	    @ExceptionHandler(CarDataDoestNotExistException.class)
	    public String handleException() {
	    	return "Exception handle methd - Data does not exist";
	    }
